  ...
  <div class="list2">
    <div class="padC">
      <div style="border:1px solid #C5DDF1; margin-bottom: 10px;padding:10px;">
        ...
        <c:if test='${not empty agrTerminalData.agrTerminalId}'>
        <option value='${agrTerminalData.agrTerminalId}'>${agrTerminalData.agrTerminal.name}</option>
        </c:if>
        <c:if test='${empty agrTerminalData.agrTerminalId}'>
        ...
        <tr class="baseinfo" style="margin:10px 0">
        <td align="right" width="80">终端mac地址：</td>
        <td> <input type="text" id="mac" name="mac" value="${fn:escapeXml(agrTerminalData.mac) }" class="inputText" style="width:500px;height:18px;"/></td>
        </tr>
        <tr class="baseinfo" style="margin:10px 0">
        <td align="right" width="80">空气温度：</td>
        <td> <input type="text" id="airTemp" name="airTemp" value="${fn:escapeXml(agrTerminalData.airTemp) }" class="inputText" style="width:500px;height:18px;"/></td>
        </tr>
        <tr class="baseinfo" style="margin:10px 0">
        <td align="right" width="80">土壤温度：</td>
        <td> <input type="text" id="soilTemp" name="soilTemp" value="${fn:escapeXml(agrTerminalData.soilTemp) }" class="inputText" style="width:500px;height:18px;"/></td>
        </tr>
        <tr class="baseinfo" style="margin:10px 0">
        <td align="right" width="80">光照强度：</td>
        <td> <input type="text" id="lux" name="lux" value="${fn:escapeXml(agrTerminalData.lux) }" class="inputText" style="width:500px;height:18px;"/></td>
        </tr>
        <tr class="baseinfo" style="margin:10px 0">
        <td align="right" width="80">空气湿度：</td>
        <td> <input type="text" id="airHumidity" name="airHumidity" value="${fn:escapeXml(agrTerminalData.airHumidity) }" class="inputText" style="width:500px;height:18px;"/></td>
        </tr>
        <tr class="baseinfo" style="margin:10px 0">
        <td align="right" width="80">土壤湿度：</td>
        <td> <input type="text" id="soilHumidity" name="soilHumidity" value="${fn:escapeXml(agrTerminalData.soilHumidity) }" class="inputText" style="width:500px;height:18px;"/></td>
        </tr>
        <tr class="baseinfo" style="margin:10px 0">
        <td align="right" width="80">CO2浓度：</td>
        <td> <input type="text" id="co2Concentration" name="co2Concentration" value="${fn:escapeXml(agrTerminalData.co2Concentration) }" class="inputText" style="width:500px;height:18px;"/></td>
        </tr>
        <tr class="baseinfo" style="margin:10px 0">
        <td align="right" width="80">删除状态：</td>
        <td> <input type="text" id="deleted" name="deleted" value="${fn:escapeXml(agrTerminalData.deleted) }" class="inputText" style="width:500px;height:18px;"/></td>
        </tr>
        <tr class="baseinfo" style="margin:10px 0">
        <td align="right" width="80">状态：</td>
        <td> <input type="text" id="status" name="status" value="${fn:escapeXml(agrTerminalData.status) }" class="inputText" style="width:500px;height:18px;"/></td>
        </tr>
        <tr class="baseinfo" style="margin:10px 0">
        <td align="right" width="80">修改时间：</td>
        <td> <input type="text" id="updateTime" name="updateTime" value="<fmt:formatDate value="${agrTerminalData.updateTime }" pattern="yyyy-MM-dd HH:mm"/>" class="inputText" style="width:500px;height:18px;"/></td>
        </tr>
        <tr class="baseinfo" style="margin:10px 0">
        ...
        <c:if test='${not empty agrTerminalData.userIdUpdate}'>
        <option value='${agrTerminalData.userIdUpdate}'>${agrTerminalData.userUpdate.name}</option>
        </c:if>
        <c:if test='${empty agrTerminalData.userIdUpdate}'>
        <option value='-1'>全部</option>
        </c:if>
        </select>
        <script>
        ...
        <td> <input type="text" id="createTime" name="createTime" value="<fmt:formatDate value="${agrTerminalData.createTime }" pattern="yyyy-MM-dd HH:mm"/>" class="inputText" style="width:500px;height:18px;"/></td>
        </tr>
        <tr class="baseinfo" style="margin:10px 0">
        ...
        <c:if test='${not empty agrTerminalData.userIdCreate}'>
        <option value='${agrTerminalData.userIdCreate}'>${agrTerminalData.userCreate.name}</option>
        </c:if>
        <c:if test='${empty agrTerminalData.userIdCreate}'>
        <option value='-1'>全部</option>
        </c:if>
        </select>
        <script>
...
<script type="text/javascript">
          var agrTerminalDataId = "${agrTerminalData.id}";
        function save(){
        var data = {};
        data.id = agrTerminalDataId;
        data.agrTerminalId = $("#agrTerminalId").val();
        data.mac = $("#mac").val();
        data.airTemp = $("#airTemp").val();
        data.soilTemp = $("#soilTemp").val();
        data.lux = $("#lux").val();
        data.airHumidity = $("#airHumidity").val();
        data.soilHumidity = $("#soilHumidity").val();
        data.co2Concentration = $("#co2Concentration").val();
        ...
        $.post("${ROOT}/resCenter/agrTerminalData/save.do",data,function(j){
        alert(j.msg);
        if(j.code == 1){
        agrTerminalDataId = j.agrTerminalDataId;
        gobackList();}},"json");}
