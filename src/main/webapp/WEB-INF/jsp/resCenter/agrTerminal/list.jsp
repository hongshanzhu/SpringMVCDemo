...
<div class="content">
  <div class="list">
        ...
        终端ID:<input name="id" value="${id}" class="inputText" style="width:50px"/>
        终端编码:<input name="no" value="${no}" class="inputText" style="width:50px"/>
        ...
        终端IP地址:<input name="ip" value="${ip}" class="inputText" style="width:50px"/>
        终端名称:<input name="name" value="${name}" class="inputText" style="width:50px"/>
        ...
        <td width="7%" align="center">${o.no}</td>
        <td width="7%" align="center">${o.agrSpace.name}</td>
        <td width="7%" align="center">${o.mac}</td>
        <td width="7%" align="center">${o.ip}</td>
        ...
        <a href="${ROOT}/resCenter/agrTerminal/form.do?id=${o.id}">修改</a>
    ...
    <script>
      ...
      function create(){
        location.href="${ROOT}/resCenter/agrTerminal/form.do";
      }
      ...
      function doRemove(ids){
        ...
        $.post("${ROOT}/resCenter/agrTerminal/delete.do",data,function(j){
          alert(j.msg);
          if(j.code == 1){
            Func.reloadPage();
          }
