...
<div class="content">
  <div class="list">
        ...
        电箱状态ID:<input name="id" value="${id}" class="inputText" style="width:50px"/>
        电箱状态:<input name="name" value="${name}" class="inputText" style="width:50px"/>
        ...
        <td width="10%" align="center">${o.deleted}</td>
        <td width="10%" align="center">${o.status}</td>
        <td width="10%" align="center"><fmt:formatDate value="${o.updateTime }" pattern="yyyy-MM-dd HH:mm"/>
        <td width="10%" align="center">${o.userUpdate.name}</td>
        <td width="10%" align="center"><fmt:formatDate value="${o.createTime }" pattern="yyyy-MM-dd HH:mm"/>
        <td width="10%" align="center">${o.userCreate.name}</td>
        <td width="10%" align="center">
        <a href="${ROOT}/resCenter/agrElectricalBoxState/form.do?id=${o.id}">修改</a>
    ...
    <script>
      ...
      function create(){
        location.href="${ROOT}/resCenter/agrElectricalBoxState/form.do";
      }
      ...
      function doRemove(ids){
        ...
        $.post("${ROOT}/resCenter/agrElectricalBoxState/delete.do",data,function(j){
          alert(j.msg);
          if(j.code == 1){
            Func.reloadPage();
          }
