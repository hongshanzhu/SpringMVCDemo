...
<div class="content">
  <div class="list">
        ...
        电箱类型ID:<input name="id" value="${id}" class="inputText" style="width:50px"/>
        电箱类型:<input name="name" value="${name}" class="inputText" style="width:50px"/>
        ...
        <a href="${ROOT}/resCenter/agrElectricalBoxType/form.do?id=${o.id}">修改</a>
    ...
    <script>
      ...
      function create(){
        location.href="${ROOT}/resCenter/agrElectricalBoxType/form.do";
      }
      ...
      function doRemove(ids){
        ...
        $.post("${ROOT}/resCenter/agrElectricalBoxType/delete.do",data,function(j){
          alert(j.msg);
          if(j.code == 1){
            Func.reloadPage();
          }
