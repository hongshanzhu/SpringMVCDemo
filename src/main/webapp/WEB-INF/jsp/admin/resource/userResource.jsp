...
List<UserResource> userResources = resourceService.listUserResources(uid);
Map<Long,UserResource> map = new HashMap<Long,UserResource>();
...
<div class="list">
<div class="listlo">
<b>${user.truename }</b> - 资源权限  <input type="button" value="返 回" class="but1" onclick="history.back()">
</div>
...
function saveUserResouce(){
	...
	//alert(data);
	$.post("/auth/resource/createUserResource.do",data,function(j){
		alert(j.msg);
		if(j.code == 1){
			Func.reloadPage();
		}
