...
List<LoginEnv> list = loginEnvService.queryAll(LoginEnv.class);
req.attr("list", list);
out.clear();
%><!DOCTYPE html>
<html>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="listtb">      	
  ...
  <tr class="${idx.index%2==0?"bluetr":"" }">
      ...
      <td width="6%" align="center">${o.user.truename}</td>
      ...
      <td width="5%" align="center">
      	<a href="javascript:deleteLoginEnv('${o.id}')">删除</a>
      </td>      
  </tr>
  </c:forEach>
</table>
...
function deleteLoginEnv(id){
	...
	$.post("/admin/loginEnv/delete/delete.json.jsp",data,function(j){
		alert(j.msg);
		if(j.code == 1){
			Func.reloadPage();
		}
