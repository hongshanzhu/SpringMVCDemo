...
<div class="content">
  <div class="list">
        ...
        视频ID:<input name="id" value="${id}" class="inputText" style="width:50px"/>
        视频编码:<input name="no" value="${no}" class="inputText" style="width:50px"/>
        ...
        监控名称:<input name="name" value="${name}" class="inputText" style="width:50px"/>
        播放地址:<input name="url" value="${url}" class="inputText" style="width:50px"/>
        ...
        <td width="7%" align="center">${o.url}</td>
        ...
        <a href="${ROOT}/resCenter/agrVideo/form.do?id=${o.id}">修改</a>
    ...
    <script>
      ...
      function create(){
        location.href="${ROOT}/resCenter/agrVideo/form.do";
      }
      ...
      function doRemove(ids){
        ...
        $.post("${ROOT}/resCenter/agrVideo/delete.do",data,function(j){
          alert(j.msg);
          if(j.code == 1){
            Func.reloadPage();
          }
