...
<div class="content">
  <div class="list">
        ...
        归属ID:<input name="id" value="${id}" class="inputText" style="width:50px"/>
        人员编码:<div style='display: inline-block'>
        <input type='hidden' id='userName' name='userName' value='${userName}'/>
        <select id='userId' name='userId' style='width: 100%;'>
        <c:if test='${not empty userId}'>
        <option value='${userId}'>${userName}</option>
        </c:if>
        <c:if test='${empty userIdId}'>
        ...
        场地编码:<div style='display: inline-block'>
        ...
        <td width="9%" align="center">${o.user.name}</td>
        <td width="9%" align="center">${o.agrSpace.name}</td>
        ...
        <a href="${ROOT}/resCenter/agrSpaceUser/form.do?id=${o.id}">修改</a>
    ...
    <script>
      ...
      function create(){
        location.href="${ROOT}/resCenter/agrSpaceUser/form.do";
      }
      ...
      function doRemove(ids){
        ...
        $.post("${ROOT}/resCenter/agrSpaceUser/delete.do",data,function(j){
          alert(j.msg);
          if(j.code == 1){
            Func.reloadPage();
          }
