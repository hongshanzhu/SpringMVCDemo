...
<div class="container">
    <ul>
        <li class="dropdown open">
            <a href="#" data-toggle="dropdown">管理平台</a>
            <ul class="dropdown-menu show">
                <li><a href="#" onclick="chlickToMain('场地管理','${ROOT}/resCenter/agrSpace/list.do');">场地管理</a></li>
                <li><a href="#" onclick="chlickToMain('场地归属','${ROOT}/resCenter/agrSpaceUser/list.do');">场地归属</a></li>
                <li><a href="#" onclick="chlickToMain('视频管理','${ROOT}/resCenter/agrVideo/list.do');">视频管理</a></li>
                <li><a href="#" onclick="chlickToMain('采集终端管理','${ROOT}/resCenter/agrTerminal/list.do');">采集终端管理</a></li>
                <li><a href="#" onclick="chlickToMain('采集数据管理','${ROOT}/resCenter/agrTerminalData/list.do');">采集数据管理</a></li>
                <li><a href="#" onclick="chlickToMain('电箱管理','${ROOT}/resCenter/agrElectricalBox/list.do');">电箱管理</a></li>
                <li><a href="#" onclick="chlickToMain('电箱状态','${ROOT}/resCenter/agrElectricalBoxState/list.do');">电箱状态</a></li>
                <li><a href="#" onclick="chlickToMain('电箱类型','${ROOT}/resCenter/agrElectricalBoxType/list.do');">电箱类型</a></li>
                <li><a href="#" onclick="chlickToMain('人员管理','${ROOT}/auth/user/list.do');">人员管理</a></li>
                <li><a href="#" onclick="chlickToMain('权限管理','${ROOT}/auth/resource/list.do');">资源管理</a></li>
            </ul>
        </li>
        <%--<li class="dropdown">--%>
