...
<div class="topHeadB">
    <div class="headLogo headLogoB">
        ...
        <a href="" style="font-size:22px">IDC运维平台</a>
      <span>欢迎您：<b>${admin}</b>
          <%----%>
<%--&nbsp; <a href="${Env.sSLHost}/passport/chgPwd.jsp?returl=${Env.host}/">修改密码</a>--%>
...
<div id="paginate-slider10" class="dmune pagination">
    ...
    <i class="toc" i="0"><a href="/admin/menu_left.do?index=0" target="submenu">资产管理</a></i>
